...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Nov 13, 2024 at 08:06 PM
...
CREATE TABLE IF NOT EXISTS `familles` (
  `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT,
  `nom_famille` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `familles` (`id`, `nom_famille`, `photo`, `description_1`, `description_2`, `ordre_id`, `tpa_id`, `tpp_id`, `npa_id`, `ta_id`, `taa_id`, `tar_id`, `nc_id`, `tc_id`, `fc_id`, `thab_id`) VALUES
...
INSERT INTO `insects` (`id`, `nom_sc`, `nom_fr`, `photo`, `description`, `famille_id`) VALUES
(1, 'Abraxas grossulariata', 'Zérène du Groseillier', 'Geometridae', 'Lépidoptère', 20),
(2, 'Abraxas sylvata', 'Zérène de l\'Orme', 'Geometridae', 'Lépidoptère', 20),
(3, 'Abrostola tripartita', 'Plusie de l\'Ortie', 'Noctuidae', 'Lépidoptère', 20),
(4, 'Acasis viretata', 'Lobophore verdâtre', 'Geometridae', 'Lépidoptère', 20),
(5, 'Acentria ephemerella', 'Acentria ephemerella', 'Crambidae', 'Lépidoptère', 20),
(6, 'Coenagrion ornatum', 'Agrion orné', 'Coenagrionidae', 'Odonate', 3),
(7, 'Coenagrion puella', 'Agrion jouvencelle', 'Coenagrionidae', 'Odonate', 3),
(8, 'Aeshna cyanea', 'Aeschne bleue', 'Aeshnidae', 'Odonate', 2),
(9, 'Aeshna grandis', 'Grande Aeschne', 'Aeshnidae', 'Odonate', 2),
(10, 'Crocothemis erythraea', 'Crocothémis écarlate', 'Libellulidae', 'Odonate', 2),
(11, 'Criorhina asilica', 'Criorhina asilica', 'Syrphidae', 'Diptera', 4),
(12, 'Episyrphus balteatus', 'Episyrphus balteatus', 'Syrphidae', 'Diptera', 4),
(13, 'Musca domestica', 'Mouche domestique', 'Muscidae', 'Diptera', 4),
(14, 'Eristalis tenax', 'Eristale gluante', 'Syrphidae', 'Diptera', 4),
(15, 'Culex pipiens', 'Moustique commun', 'Culicidae', 'Diptera', 4),
(16, 'Chorthippus biguttulus', 'Criquet mélodieux', 'Acrididae', 'Orthoptère', 1),
(17, 'Chorthippus brunneus', 'Criquet duettiste', 'Acrididae', 'Orthoptère', 1),
(18, 'Conocephalus dorsalis', 'Conocéphale des Roseaux', 'Tettigoniidae', 'Orthoptère', 1),
(19, 'Conocephalus fuscus', 'Conocéphale bigarré', 'Tettigoniidae', 'Orthoptère', 1),
(20, 'Decticus verrucivorus', 'Dectique verrucivore', 'Tettigoniidae', 'Orthoptère', 1),
(21, 'Coreus marginatus', 'Corée marginée', 'Coreidae', 'Hémiptère', 8),
(22, 'Pyrrhocoris apterus', 'Corizus hyoscyami hyoscyami', 'Rhopalidae', 'Hémiptère', 8),
(23, 'Macrosiphum rosae', 'Puceron vert du rosier', 'Aphididae', 'Hémiptère', 10),
(24, 'Macrosiphum rosae', 'Puceron vert du rosier ailé', 'Aphididae', 'Hémiptère', 21),
(25, 'Cercopis vulnerata', 'Cercope', 'Cercopidae', 'Hémiptère', 9),
(26, 'Cetonia aurata', 'Cétoine dorée', 'Scarabaeidae', 'Coléo', 7),
(27, 'Coccinella septempunctata', 'Coccinelle à 7 points', 'Coccinellidae', 'Coléo', 7),
(28, 'Chrysolina americana', 'Chrysomèle du romarin', 'Carabidae', 'Coleoptère', 7),
(29, 'Ocypus olens', 'Staphylin noir', 'Staphylinidae', 'Coléo', 6),
(30, 'Staphylinus caesareus', 'Staphylin à raies d\'or', 'Staphylinidae', 'Coléo', 6),
(31, 'Bombus terrestris', 'Bourdon terrestre', 'Apidae', 'Hymé', 18),
(32, 'Vespula vulgaris', 'Guêpe commune', 'Vespidae', 'Hymé', 18),
(33, 'Apis mellifera', 'Abeille européenne', 'Apidae', 'Hymé', 18),
(34, 'Lasius niger', 'Fourmi noire', 'Formicidae', 'Hymé', 19),
(35, 'Camponotus ligniperdus', 'Fourmi charpentière', 'Formicidae', 'Hymé', 19),
(36, 'Lepisma saccharinea', 'Poisson d\'argent', 'Lepismatidae', 'Zygentome', 16),
(37, 'Chrysoperla carnea', 'Chrysope verte', 'Chrysopidae', 'Névroptère', 15),
(38, 'Myrmeleon formicarius', 'Fourmilion commun', 'Myrmeleontidae', 'Névroptère', 15),
(39, 'Nemoura cinerea', 'Nemoura cinerea', 'Nemouridae', 'Plécoptères', 14),
(40, 'Cloeon simile', 'Cloeon simile', 'Baetidae', 'Ephémère', 5),
(41, 'Blattella germanica', 'Blatte germanique', 'Blattellidae', 'Blattoptère', 11),
(42, 'Mantis religiosa', 'Mante religieuse', 'Mantidae', 'Mantoptère', 17),
(43, 'Phryganea grandis', 'Grande Phrygane', 'Phryganeidae', 'Trichoptère', 13),
(44, 'Forficula auricularia', 'Perce-oreille', 'Forficulidae', 'Dermaptère', 12);
...
(4, 'alula', 'alula@gmail.com', NULL, '$2y$12$OmAoCK.5Wxz2mLzKQct7Pucc.SoqLVXIZltEFNwDj051FpCMPbFvK', NULL, '2024-11-07 06:56:08', '2024-11-07 06:56:08');
COMMIT;
